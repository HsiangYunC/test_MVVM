...
namespace Test_2Views
{
    ...
    public class View2Controller
    {
        ...
        /// ViewModelList
        /// </summary>
        public BindingList<View2Model> ViewModelList { get; } // bind view
        ...
        private void Initialize()
        {
            ...
            {
                var parentNode = new View2Model(model, Guid.Empty);
                ...
                if (DataSource.ModelList2.TryGetValue(parentNode.ID, out var subItems))
                {
                    ...
                    {
                        var childNode = new View2Model(subitem, parentNode.ID);
